...
export default class Header extends Component {
  ...
  render() {
    return (
      <Navbar dark expand="md" className="navbar-header">
          ...
          <Collapse isOpen={this.state.isNavOpen} navbar>
            <Nav className="ml-auto nav__items align-items-center" navbar>
              ...
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu>
                  <DropdownItem>
                    <NavLink className="nav-link" to="/about/1">
                      About DRISHTI CPS
                    </NavLink>
                  </DropdownItem>
                  <DropdownItem>
                    <NavLink className="nav-link" to="/about/2">
                      Governing Body
                    </NavLink>
                  </DropdownItem>
                  <DropdownItem>
                    <NavLink className="nav-link" to="/about/3">
                      Advisory Board
                    </NavLink>
                  </DropdownItem>
                  <DropdownItem>
                    <NavLink className="nav-link" to="/about/4">
                      Core Team
                    </NavLink>
                  </DropdownItem>
                  <DropdownItem>
                    <NavLink className="nav-link" to="/about/5">
                      What do we do?
                    </NavLink>
                  </DropdownItem>
                </DropdownMenu>
